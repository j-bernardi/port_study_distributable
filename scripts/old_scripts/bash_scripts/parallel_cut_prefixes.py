...
only_file_prefixes = ["OB"]#["bss"] #empty string defaults to all
...
first_wall_prefix = 'OB' #Note-this MUST completely encase/cut the ports (ie overhang will produce an errr)
